                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="download_pdf">
                                        <a rel="tooltip" class="btn btn-secondary m-btn m-btn--air m-btn--custom" title="Download Invoice" href="{{ route('receipts.invoicepdf',$detail['receipt_id']) }}" target="_blank" download>
