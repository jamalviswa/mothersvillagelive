                                ...
                                <table class="table m-table m-table--head-bg-brand">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Land Cost<br>(in Rupees)</th>
                                            <th>Construction Cost<br>(in Rupees)</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $result->construction_cost }}</td>
                                                <td class="text-center">{{ $result->gross_amount }}</td>
                                                <td class="text-center">{{ $result->total_amount }}</td>
                                                <?php
                                                if ($sessionadmin->adminname == "Admin") {
                                                ?>
