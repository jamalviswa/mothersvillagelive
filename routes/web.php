...
Route::any('customers/all/index', 'CustomersController@index')->name('customers.index');
Route::get('customers/exports/', 'CustomersController@export')->name('customers.export');
...
Route::get('blocks/invoiceblockpdf', 'BlocksController@invoiceblockpdf')->name('blocks.invoiceblockpdf');
Route::get('blocks/receiptformblock', 'BlocksController@receiptformblock')->name('blocks.receiptformblock');
//Master
